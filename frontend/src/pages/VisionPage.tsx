        ...
        <div className="bg-background border border-border shadow-sm">
          <div className="p-6 space-y-6">
            <div className="prose dark:prose-invert max-w-none 
              ...
              prose-h1:text-4xl prose-h1:font-bold prose-h1:text-primary prose-h1:mb-6
              prose-h2:text-3xl prose-h2:font-semibold prose-h2:text-secondary prose-h2:mt-10 prose-h2:mb-4
              prose-h3:text-2xl prose-h3:font-medium prose-h3:mt-8 prose-h3:mb-3
              prose-a:text-primary prose-a:no-underline hover:prose-a:underline
              prose-blockquote:border-l-4 prose-blockquote:border-primary
              prose-code:bg-muted prose-code:p-1
              prose-hr:border-border prose-hr:my-10
              prose-p:leading-relaxed
              prose-ul:mt-2 prose-ol:mt-2 prose-li:mb-1
